...
Item {
    ...
    MouseArea {
        ...
        WallpaperFader {
            ...
            source: wallpaper
            mainStack: mainStack
            footer: header // Changed from footer to header
            clock: clock
        }
        ...
        Image {
            ...
            source: config.logo
            anchors.horizontalCenter: parent.horizontalCenter
            anchors.bottom: header.top // Changed from footer to header
    ...
    Connections {
        ...
        function onLoginFailed() {
            ...
            header.enabled = true // Changed from footer to header
        ...
        function onLoginSucceeded() {
            ...
            mainStack.opacity = 0
            header.opacity = 0 // Changed from footer to header
        }
    }
